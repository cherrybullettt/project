    ...
    <div class="navbar bg-base-200">
        <details class="dropdown " id="manage">
            ...
            <ul class="ManageDrop p-2 shadow menu dropdown-content z-[1] bg-base-200 rounded-box w-max text-lg">
                ...
                <li><a href="manage_game.php" class=" mt-2 mb-2 group hover:text-xl"><i
                            class="fa-solid fa-circle fa-beat" style="color: #ffffff;"></i>จัดการทะเบียนเกม</a></li>
                    ...
                    <table class="table text-lg">
                        ...
                        <tbody>
                            ...
                            <tr class="text-lg">
                                ...
                                <td>
                                    <button class="btn-g-e btn btn-outline w-16 text-lg"
                                        onclick="EditeGame(this)">แก้ไข</button>
