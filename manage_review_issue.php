...
<head>
    ...
    <link rel="stylesheet" href="css/manage_review_issue.css">
    <script src="javaScript/manage_review_issue.js" defer></script>
...
<body>
    ...
    <div class="navbar bg-base-200">
        <details class="dropdown " id="manage">
            ...
            <ul class="ManageDrop p-2 shadow menu dropdown-content z-[1] bg-base-200 rounded-box w-max text-lg">
                ...
                <li><a href="manage_review_issue.php" class=" mt-2 mb-2 group hover:text-xl"><i class="fa-solid fa-circle fa-beat" style="color: #ffffff;"></i>จัดการประเด็นรีวิว</a></li>
    ...
    <div class="ContrainerManageReviewIssues">
        <div class="row">
            <div class="col1">
                <p class="text-3xl">จัดการประเด็นรีวิว</p>
            </div>
        </div>
        <div class="row">
            <div class="col2">
                <p class="text-2xl">ค้นหาเกม</p>
                ...
                <select class="select w-full max-w-xs bg-[#fff] text-black text-lg">
                    <option disabled selected>--- เลือกเกม ---</option>
                    <option>EA Sports FC 24</option>
        ...
        <div class="row">
            <div class="col3">
                <div class="container add-category">
                    <p class="fontWeight text-2xl">เพิ่มประเด็นรีวิว</p>
                    <p class="text-lg">เพิ่มประเด็นรีวิว <span style="color: red;">(สูงสุด 2 ประเด็น)</span></p>
                    <input type="text" id="AddCategory" placeholder="เพิ่มหมวดหมู่เกม"
                        class="input input-bordered input-info w-full max-w-xs" />
                    <button class="AddCategoryConfirm btn w-max text-lg">ยืนยัน</button>
                </div>

                <div class="container edit-category">
                    <p class="fontWeight text-2xl">แก้ไขประเด็นรีวิว</p>
                    <p class="text-lg">ประเด็น</p>
                    <input type="text" id="EditCategory" placeholder="ประเด็น"
                    ...
                    <p class="text-lg">แก้ไขชื่อประเด็น</p>
                    <input type="text" id="DescCategory" placeholder="แก้ไขชื่อประเด็น"
                        class="input input-bordered input-info w-full max-w-xs" />
                ...
                <div class="container delete-category">
                    <p class="fontWeight text-2xl">ลบประเด็นรีวิว</p>
                    <p class="text-lg">ลบประเด็นรีวิว</p>
                    <input type="text" id="DeleteCategory" placeholder="ลบประเด็นรีวิว"
                        class="input input-bordered input-info w-full max-w-xs" list="gameCategory" />
                    <datalist id="gameCategory">
                        <option value="แอ็กชั่น"></option>
                        <option value="ผู้เล่นคนเดียว"></option>
            ...
            <div class="col4">
                <div class="container all-category">
                    <p class="fontWeight text-xl">ประเด็นเกมที่เลือก : <span id="categoryCount">5</span></p>
                        ...
                        <table class="table text-lg">
                            ...
                            <thead>
                                <tr class="text-lg tableHeaders">
                                    <th></th>
                                    <th class="tableHeadersName">ชื่อประเด็น</th>
                                    <th>หมายเหตุ</th>
                                </tr>
                            </thead>
                            <tbody>
                                <!-- row 1 -->
                                <tr class="text-lg">
                                    <th class="NoEdit">1</th>
                                    <td class="NoEdit">การเล่น</td>
                                    <td class="NoEdit Don">ประเด็นหลัก ห้ามแก้ไข</td>
                                </tr>
                                <!-- row 2 -->
                                <tr class="text-lg">
                                    <th class="NoEdit">2</th>
                                    <td class="NoEdit">เนื้อเรื่อง</td>
                                    <td class="NoEdit Don">ประเด็นหลัก ห้ามแก้ไข</td>
                                </tr>
                                <!-- row 3 -->
                                <tr class="text-lg">
                                    <th class="NoEdit">3</th>
                                    <td class="NoEdit">ประสิทธิภาพ</td>
                                    <td class="NoEdit Don">ประเด็นหลัก ห้ามแก้ไข</td>
                                </tr>
                                <!-- row 4 -->
                                <tr class="text-lg">
                                    <th>4</th>
                                    <td id="NameCategory">สังคมเกม</td>
                                    <td></td>
                                </tr>
                                <!-- row 5 -->
                                <tr class="text-lg">
                                    <th>5</th>
                                    <td id="NameCategory">ความสมจริง</td>
                                    <td></td>
                                </tr>
                            </tbody>
                        </table>
                ...
                <div class="container all-category">
                    <p class="fontWeight text-xl">ประเด็นเกมทั้งหมด : <span id="categoryCount">5</span></p>
                    <div class="tableM overflow-x-auto text-black">
                        <table class="table text-lg">
                            <!-- head -->
                            <thead>
