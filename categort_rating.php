...
<head>
    ...
    <link rel="stylesheet" href="css/categort_rating.css">
    <script src="javaScript/categort_rating.js" defer></script>
...
<body>
    ...
    <div class="navbar bg-base-200">
        <details class="dropdown " id="manage">
            ...
            <ul class="ManageDrop p-2 shadow menu dropdown-content z-[1] bg-base-200 rounded-box w-max text-lg">
                <li><a href="manage_member.php" class="li1 mt-2 mb-2 group hover:text-xl"><i class="fa-solid fa-circle" style="color: #a3a3a3;"></i>จัดการข้อมูลสมาชิก</a></li>
                ...
                <li><a href="categort_rating.php" class=" mt-2 mb-2 group hover:text-xl"><i class="fa-solid fa-circle fa-beat" style="color: #ffffff;"></i>จัดการหมวดหมู่เรตติ้งเกม</a>
                </li>
    ...
    <div class="ContrainerCategoryRating">
        <div class="row">
            <div class="col1">
                <p class="text-3xl">จัดการหมวดหมู่เรตติ้งเกม</p>
            </div>
        </div>

        <div class="row">
            <div class="col2">
                <p class="text-2xl">Rating Organization</p>
                <select class="select select-bordered bg-[#fff] w-full max-w-xs text-black text-lg">
                    <option>ESRB (USA)</option>
                    <option>PEGI (Europe)</option>
                    <option>CERO (Japan)</option>
                </select>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col3">
                <div class="container add-category">
                    <p class="fontWeight text-2xl">เพิ่มหมวดหมู่เรตติ้งเกม</p>
                    <p class="text-lg">หมวดหมู่เรตติ้งเกม</p>
                    <input type="text" id="AddCategory" placeholder="เพิ่มหมวดหมู่เรตติ้งเกม"
                        class="input input-bordered input-info w-full max-w-xs" />
                    <button class="AddCategoryConfirm btn w-max text-lg">ยืนยัน</button>
                </div>

                <div class="container edit-category">
                    <p class="fontWeight text-2xl">แก้ไขหมวดหมู่เรตติ้งเกม</p>
                    <p class="text-lg">หมวดหมู่เรตติ้งเกม</p>
                    <input type="text" id="EditCategory" placeholder="หมวดหมู่เรตติ้งเกม"
                        class="input input-bordered input-info w-full max-w-xs" list="gameCategory" />
                    <datalist id="gameCategory">
                        <option value="E"></option>
                        <option value="M"></option>
                        <option value="asdf"></option>
                    </datalist>
                    <p class="text-lg">Rating Organization</p>
                    <select class="select select-bordered bg-[#fff] w-full max-w-xs text-black text-lg"
                        id="EditSeclect">
                        <option disabled selected>--- Rating Organization ---</option>
                        <option>ESRB (USA)</option>
                        <option>PEGI (Europe)</option>
                        <option>CERO (Japan)</option>
                    </select>
                    <p class="text-lg">คำอธิบายเรตติ้ง</p>
                    <input type="text" id="DescCategory" placeholder="หมวดหมู่เรตติ้งเกม"
                        class="input input-bordered input-info w-full max-w-xs" />
                    <div class="EditFooter">
                        <button class="EditCategoryClear btn w-max text-lg"
                            onclick="EditCategoryClearButton()">ล้างข้อมูล</button>
                        <button class="EditCategoryConfirm btn w-max text-lg"
                            onclick="EditCategoryConfirmButton()">ยืนยัน</button>
                    </div>
                </div>

                <div class="container delete-category">
                    <p class="fontWeight text-2xl">ลบหมวดหมู่เรตติ้งเกม</p>
                    <p class="text-lg">ลบหมวดหมู่เรตติ้งเกม</p>
                    <input type="text" id="DeleteCategory" placeholder="ลบหมวดหมู่เรตติ้งเกม"
                        class="input input-bordered input-info w-full max-w-xs" list="gameCategory" />
                    <datalist id="gameCategory">
                        <option value="E"></option>
                        <option value="M"></option>
            ...
            <div class="col4">
                <div class="container all-category">
                    <p class="fontWeight text-xl">หมวดหมู่เรตติ้งเกมทั้งหมด : <span id="categoryCount">10</span></p>
                        ...
                        <table class="table text-lg">
                            ...
                            <thead>
                                <tr class="text-lg tableHeaders">
                                    <th></th>
                                    <th class="tableHeadersName">ชื่อเรตติ้ง</th>
                                    <th class="tableHeadersEmail">คำอธิบายเรตติ้ง</th>
                                </tr>
                            </thead>
                            <tbody>
                                <!-- row 1 -->
                                <tr class="text-lg">
                                    <th>1</th>
                                    <td id="NameRating">M(17 ปี ขึ้นไป)</td>
                                    <td id="DescRating">(17 ปี ขึ้นไป)</td>
                                </tr>
                                <!-- row 2 -->
                                <tr class="text-lg">
                                    <th>2</th>
                                    <td id="NameRating">M</td>
                                    <td id="DescRating">(17 ปี ขึ้นไป)</td>
                                </tr>
                                <!-- row 3 -->
                                <tr class="text-lg">
