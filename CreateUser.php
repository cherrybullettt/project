...
<head>
    ...
    <script src="JavaScript/CreateUser.js" defer></script>
...
<body class="text-white">
    ...
    <div class="navbar bg-base-200">
        ...
        <div class="flex-none gap-2">
            ...
            <div class="navbar-end w-28 md:w-auto" id="login-button-container">
                <!-- <a href="login.php" class="btn" id="login-button">เข้าสู่ระบบ</a> -->
    ...
    <div class="container">
        <div class="cr-ac">
            <h2 class="mb-10 mt-6">สร้างบัญชีผู้ใช้งาน</h2>
            <div class="input-container mb-6">
                <p class="mb-2">ชื่อบัญชี<span class="red-asterisk">*</span></p>
                <!-- <input type="username" id="username" name="username" placeholder="ชื่อบัญชี (สูงสุด 20 ตัวอักษร)"> -->
                <input type="username" id="username" placeholder="ชื่อบัญชี (สูงสุด 20 ตัวอักษร)"
                    class="input input-bordered input-info text-white w-full h-11 max-w-auto" />
            </div>
            <div class="input-container mb-6">
                <p class="mb-2">อีเมล<span class="red-asterisk">*</span></p>
                <!-- <input type="email" id="email" name="email" placeholder="อีเมล (example@hotmail.com)"> -->
                <input type="email" id="email" placeholder="อีเมล (example@hotmail.com)"
                    class="input input-bordered input-info text-white w-full h-11 max-w-auto" />
            </div>
            <div class="input-container mb-6">
                <p class="mb-2">วันเกิด (วัน/เดือน/ปี)<span class="red-asterisk">*(ขั้นตํ่าอายุ 13 ปีขึ้นไป)</span></p>
                <!-- <input type="date" id="birthdate" name="birthdate" onclick="showDatePicker()"> -->
                <input type="date" id="birthdate"
                    class="input input-bordered input-info text-white w-full h-11 max-w-auto"
                    onclick="showDatePicker()" />
            </div>
            <div class="input-container mb-6">
                <p class="mb-2">รหัสผ่าน<span class="red-asterisk">*</span></p>
                <!-- <input type="password" id="password" name="password" placeholder="รหัสผ่าน"> -->
                <input type="password" id="password" placeholder="รหัสผ่าน"
                    class="input input-bordered input-info text-white w-full h-11 max-w-auto" />
            </div>
            <div class="input-container mb-6">
                <p class="mb-2">ยืนยันรหัสผ่าน<span class="red-asterisk">*</span></p>
            ...
            <div class="button-container mb-6 mt-12">
                <button type="button" class="login-button-form-clear btn" onclick="ClearD()">ล้างข้อมูล</button>
                <button type="button" class="login-button-form-create btn" onclick="CreateU()">สร้างบัญชี</button>
            </div>

            <div class="signup-link mb-4">
                <span>มีบัญชีแล้วหรือไม่?</span>
                <a href="login.php" class="signup">เข้าสู่ระบบ</a>
            </div>
        </div>
    </div>
