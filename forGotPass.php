...
<head>
    ...
    <script src="JavaScript/forGotPass.js" defer></script>
...
<body class="text-white">
    ...
    <div class="container-fgp">
        <form class="forgot-password-form-fgp">
            <h2 class="mb-5 mt-6">ลืมรหัสผ่าน</h2>
            <p class="mb-6">โปรดกรอกอีเมลที่สมัครสมาชิกไว้และรอรับอีเมลรีเซ็ตรหัสผ่าน</p>
            <div class="form-group-fgp  mb-6">
            ...
            <button type="button" class="send-button btn mb-6 mt-4" onclick="SendMail()">ส่ง</button>
        </form>
    </div>
