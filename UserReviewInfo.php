                ...
                <div class="popup-content">
                    <div class="main-box-edit bg-base-100">
                        <div class="review-input">
                            <h2>แก้ไขรีวิว</h2>
                            <p>เขียนรีวิว</p>
                            <textarea class="review-input-text-ed textarea textarea-info text-xl bg-white rounded-2xl"
                ...
                <div class="popup-content-po">
                    <div class="main-box-post bg-base-100">
                        <div class="review-input-post">
                            ...
                            <p>เขียนโพสต์รีวิว</p>
                            <textarea class="review-input-text-post textarea textarea-info text-xl bg-white rounded-2xl"
                ...
                <div class="col1Info">
                    ...
                    <div class="left-u">
                        ...
                        <div class="textAreaInfo">
                            <textarea id="userReview" rows="3" cols="65"
                        ...
                        <div class="container container-score-review">
                            <div class="col-content-review col-content-1-review">
                                <!-- Content of Col 1 -->
                                <p>คะแนนเกม</p>
                                <div class="ScoreShowReviewInfo" role="progressbar" aria-valuenow="65" aria-valuemin="0"
