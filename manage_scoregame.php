...
<head>
    ...
    <link rel="stylesheet" href="css/manage_scoregame.css">
    <script src="javaScript/manage_scoregame.js" defer></script>
...
<body>
    ...
    <div class="navbar bg-base-200">
        <details class="dropdown " id="manage">
            ...
            <ul class="ManageDrop p-2 shadow menu dropdown-content z-[1] bg-base-200 rounded-box w-max text-lg">
                ...
                <li><a href="manage_scoregame.php" class=" mt-2 mb-2 group hover:text-xl"><i class="fa-solid fa-circle fa-beat" style="color: #ffffff;"></i>ตรวจสอบคะแนนเกม</a></li>
    ...
    <div class="ContrainerManageGameScore">
        <div class="row">
            <div class="col1">
                <p class="text-3xl">ตรสจสอบคะแนนเกม</p>
            </div>
        </div>
        <div class="row">
            <div class="col2">
                    ...
                    <table class="table text-lg">
                        ...
                        <thead>
                            <tr class="text-lg tableHeaders">
                                <th></th>
                                <th class="tableHeadersName">ชื่อเกม</th>
                                <th class="tableHeadersEmail">คะแนนรีวิว</th>
                                <th class="tableHeadersDate">จำนวนรีวิว</th>
                                <th class="tableHeadersStatus">จำนวนโพสตืรีวิว</th>
                            </tr>
                        </thead>
                        <tbody>
                            <!-- row 1 -->
        ...
        <div class="row">
            <div class="col5">
                ...
                <p class="text-lg" id="userCount">จำนวนเกมที่มีคะแนนทั้งหมด : <span id="countValue">10</span></p>
            </div>
            <div class="col6">
