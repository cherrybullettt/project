...
<head>
    ...
    <link rel="stylesheet" href="css/manage_comment.css">
    <script src="javaScript/manage_comment.js" defer></script>
...
<body>
    ...
    <div class="navbar bg-base-200">
        <details class="dropdown " id="manage">
            ...
            <ul class="ManageDrop p-2 shadow menu dropdown-content z-[1] bg-base-200 rounded-box w-max text-lg">
                ...
                <li><a href="recommend_game.php" class=" mt-2 mb-2 group hover:text-xl"><i class="fa-solid fa-circle"
                            style="color: #a3a3a3;"></i>จัการแนะนำเกม</a></li>
                ...
                <li><a href="categort_rating.php" class=" mt-2 mb-2 group hover:text-xl"><i class="fa-solid fa-circle"
                            style="color: #a3a3a3;"></i>จัดการหมวดหมู่เรตติ้งเกม</a></li>
                ...
                <li><a href="manage_comment.php" class=" mt-2 mb-2 group hover:text-xl"><i
                            class="fa-solid fa-circle fa-beat" style="color: #ffffff;"></i>จัดการความคิดเห็น</a></li>
                ...
                <li><a href="manage_review_issue.php" class=" mt-2 mb-2 group hover:text-xl"><i
                            class="fa-solid fa-circle" style="color: #a3a3a3;"></i>จัดการประเด็นรีวิว</a></li>
    ...
    <div class="ContrainerManageComment">
        <div class="row">
            <div class="col1">
                <p class="text-3xl">จัดการความคิดเห็น</p>
            </div>
        </div>
        <div class="row">
            <div class="col2">
        ...
        <div class="row">
            <div class="col5">
                ...
                <p class="text-lg" id="userCount">จำนวนความคิดเห็นทั้งหมด : <span id="countValue">10</span></p>
            </div>
            <div class="col6">
