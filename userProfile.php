    ...
    <div class="centered-container">
        <div class="user-porfile">
            <div data-theme="dracula" class="header-up text-white">
                ...
                <div class="circle-image">
                    ...
                    <input type="file" accept="image/png, image/jpg, image/jpeg"
                        class="file-input file-input-bordered file-input-warning max-w-xs" id="input-file" />
            ...
            <div class="show-name-and-email">
                <div class="data-name">
                    ...
                    <input type="text" id="name"
                        class="input input-bordered input-info text-white w-full h-12 max-w-auto"/>
                </div>
                <div class="data-email">
                    <!-- <input type="email" id="email" name="email"> -->
                    <input type="email" id="email"
                        class="input input-bordered input-info text-white w-full h-12 max-w-auto" readonly/>
                </div>
            </div>
            ...
            <div class="birthday-lable">
                ...
                <input type="date" id="birthdate" class="input input-bordered input-info w-full h-12 max-w-auto"
