...
<head>
    ...
    <script src="javaScript/manage_review.js" defer></script>
...
<body>
    ...
    <div class="navbar bg-base-200">
        <details class="dropdown " id="manage">
            ...
            <ul class="ManageDrop p-2 shadow menu dropdown-content z-[1] bg-base-200 rounded-box w-max text-lg">
                ...
                <li><a href="manage_review.php" class=" mt-2 mb-2 group hover:text-xl"><i class="fa-solid fa-circle fa-beat" style="color: #ffffff;"></i>จัดการรีวิว</a></li>
            </ul>
        </details>
        <div class="flex-1">
    ...
    <div class="ContrainerManageReview">
        <div class="row">
            <div class="col1">
                <p class="text-3xl">จัดการรีวิว</p>
            </div>
        </div>
        <div class="row">
            <div class="col2">
        ...
        <div class="row">
            <div class="col5">
                ...
                <p class="text-lg" id="userCount">จำนวนรีวิวทั้งหมด : <span id="countValue">10</span></p>
            </div>
            <div class="col6">
