    ...
    <div class="navbar bg-base-200">
        ...
        <div class="flex-none gap-2">
            ...
            <div class="dropdown dropdown-end" id="profile-menu">
                ...
                <ul tabindex="0"
                    class="mt-3 z-[1] p-2 shadow menu menu-sm dropdown-content bg-base-100 rounded-box lg:min-w-max" id="ProfileNavbar">
                    <li>
    ...
    <div class="container ">
                    ...
                    <div id="default-carousel" class="relative" data-carousel="static">
                        ...
                        <div class="overflow-hidden relative h-56 rounded-3xl sm:h-64 xl:h-80 2xl:h-full">
                            ...
                            <div class="hidden duration-700 ease-in-out" data-carousel-item>
                                <span
                                    class="absolute top-1/2 left-1/2 text-2xl text-white -translate-x-1/2 -translate-y-1/2 sm:text-3xl "></span>
                                <a href="Search.php">
                                    <img src="https://images.shopcdn.co.uk/86/38/8638a710f067c10c8d117d1956eb67ce/1400x787/webp/resize"
                                        id="image-gmae"
                                        class="block absolute top-1/2 left-1/2 w-full h-full -translate-x-1/2 -translate-y-1/2">
                                </a>
                                <div class="top-left-box-in">
                                    <div class="ScoreShow" role="progressbar" aria-valuenow="65" aria-valuemin="0"
                            ...
                            <div class="hidden duration-700 ease-in-out" data-carousel-item>
                                <a href="Search.php">
                                    <img src="imagesgame/gta.jpg" id="image-gmae"
                                        class="block absolute top-1/2 left-1/2 w-full h-full -translate-x-1/2 -translate-y-1/2">
                                </a>
                                <div class="top-left-box-in">
                                    <div class="ScoreShow" role="progressbar" aria-valuenow="65" aria-valuemin="0"
                            ...
                            <div class="hidden duration-700 ease-in-out" data-carousel-item>
                                <a href="Search.php">
                                    <img src="imagesgame/league of legends.jpg" id="image-gmae"
                                        class="block absolute top-1/2 left-1/2 w-full h-full -translate-x-1/2 -translate-y-1/2">
                                </a>
                                <div class="top-left-box-in">
                                    <div class="ScoreShow" role="progressbar" aria-valuenow="65" aria-valuemin="0"
                            ...
                            <div class="hidden duration-700 ease-in-out" data-carousel-item>
                                <a href="Search.php">
                                    <img src="imagesgame/gta2.jpg" id="image-gmae"
                                        class="block absolute top-1/2 left-1/2 w-full h-full -translate-x-1/2 -translate-y-1/2">
                                </a>
                                <div class="top-left-box-in">
                                    <div class="ScoreShow" role="progressbar" aria-valuenow="65" aria-valuemin="0"
                            ...
                            <div class="hidden duration-700 ease-in-out" data-carousel-item>
                                <a href="Search.php">
                                    <img src="imagesgame/cities 2.jpg" id="image-gmae"
                                        class="block absolute top-1/2 left-1/2 w-full h-full -translate-x-1/2 -translate-y-1/2">
                                </a>
                                <div class="top-left-box-in">
                                    <div class="ScoreShow" role="progressbar" aria-valuenow="65" aria-valuemin="0"
                        ...
                        <div class="circle-slide flex absolute bottom-5 left-1/2 z-30 space-x-3 -translate-x-1/2 ">
                            <button type="button" class="slide-button w-3 h-3 rounded-full" aria-current="false"
                        ...
                        <button type="button"
                            ...
                            data-carousel-prev>
                            <span
                                class="inline-flex justify-center items-center w-8 h-8 -ml-9 rounded-full sm:w-10 sm:h-10 bg-white/30  group-focus:ring-4 group-focus:ring-white  group-focus:outline-none">
                                <svg class="w-5 h-5 text-white sm:w-6 sm:h-6 -ml-0" fill="none" stroke="currentColor"
                        ...
                        <button type="button"
                            ...
                            data-carousel-next>
                            <span
                                class="inline-flex justify-center items-center w-8 h-8 -mr-9 rounded-full sm:w-10 sm:h-10 bg-white/30 group-focus:ring-4 group-focus:ring-white  group-focus:outline-none">
                                <svg class="w-5 h-5 text-white sm:w-6 sm:h-6 -mr-0" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="3"
                                        d="M9 5l7 7-7 7"></path>
                                </svg>
            ...
            <div class="bottom-content">
                ...
                <div class="container-f">
                    <div class="left">
                        ...
                        <a href="Search.php">
                            <img class="gameImage-f" id="gameImageID"
                                src="https://cdn.cloudflare.steamstatic.com/steam/apps/949230/capsule_616x353.jpg?t=1698326456">
                        </a>
                    </div>
                    <div class="content-f">
                        ...
                        <div class="hea">
                            ...
                            <div class="dropdownBox dropdown dropdown-bottom">
                                ...
                                <ul tabindex="0"
                                    class="dropdown-content z-[1] menu p-1 shadow rounded-box -ml-5 -mt-4 bg-[#e2384f] group hover:bg-[#dd1933]">
                                    <li><a>รายงาน</a></li>
                                </ul>
                            </div>
                            </p>
                        ...
                        <textarea id="userReview-f" rows="2" cols="65" placeholder="ข้อความเขียนรีวิว....."
                            readonly></textarea>
                        <div class="container container-score">
                            <div class="col-content col-content-1">
                                <!-- Content of Col 1 -->
                                <p>คะแนนเกม</p>
                                <div class="ScoreShowBotton" role="progressbar" aria-valuenow="65" aria-valuemin="0"
                                    aria-valuemax="100" style="--value:38"></div>
                            </div>
                ...
                <div class="container-f">
                    <div class="left">
                        ...
                        <a href="">
                            <img class="gameImage-f" id="gameImageID"
                                src="https://image.api.playstation.com/vulcan/ap/rnd/202203/1520/e6VbPQ56CBzVPgKmWdMMrICz.png">
                        </a>
                    </div>
                    <div class="content-f">
                        <!-- ส่วนเนื้อหาที่คุณต้องการให้อยู่ในกล่องสีขาว -->
        ...
        <div class="right-content">
            ...
            <div class="main-box">
                <div class="image-box">
                    <a href="Search.php">
                        <img src="https://bloximages.newyork1.vip.townnews.com/dailynebraskan.com/content/tncms/assets/v3/editorial/a/45/a45a52a4-87a8-11ec-84c4-73068fc6732d/620060b069298.image.jpg?resize=1200%2C675"
                            class="small-image">
                    </a>
                    <div class="top-left-box">
                        <div class="ScoreShowRight" role="progressbar" aria-valuenow="65" aria-valuemin="0"
                            aria-valuemax="100" style="--value:38"></div>
                    </div>
                </div>
            ...
            <div class="main-box">
                <div class="image-box">
                    <a href="Search.php">
                        <img src="https://cdn2.unrealengine.com/egs-deadbydaylight-behaviourinteractive-s1-2560x1440-077a46d66d9e.jpg?h=270&quality=medium&resize=1&w=480"
                            class="small-image">
                    </a>
                    <div class="top-left-box">
                        <div class="ScoreShowRight" role="progressbar" aria-valuenow="65" aria-valuemin="0"
            ...
            <div class="main-box">
                <div class="image-box">
                    <a href="Search.php">
                        <img src="https://www.cnet.com/a/img/resize/c69b3de3253ef30374f628e48276389867965614/hub/2021/09/09/1a3fc047-89b6-4459-8ff6-9813839619fc/screen-shot-2021-09-09-at-4-41-55-pm.png?auto=webp&fit=crop&height=675&width=1200"
                            class="small-image">
                    </a>
                    <div class="top-left-box">
                        <div class="ScoreShowRight" role="progressbar" aria-valuenow="65" aria-valuemin="0"
