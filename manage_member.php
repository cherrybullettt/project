...
<head>
    ...
    <link rel="stylesheet" href="css/manage_member.css">
    <script src="javaScript/manage_member.js" defer></script>
...
<body>
    ...
    <div class="navbar bg-base-200">
        <details class="dropdown " id="manage">
            ...
            <ul class="ManageDrop p-2 shadow menu dropdown-content z-[1] bg-base-200 rounded-box w-max text-lg">
                <li><a href="manage_member.php" class=" mt-2 mb-2 group hover:text-xl"><i class="fa-solid fa-circle fa-beat" style="color: #ffffff;"></i>จัดการข้อมูลสมาชิก</a></li>
                ...
                <li><a href="manage_reiew.php" class=" mt-2 mb-2 group hover:text-xl"><i class="fa-solid fa-circle" style="color: #a3a3a3;"></i>จัดการรีวิว</a></li>
            </ul>
        </details>
        <div class="flex-1">
    ...
    <div class="ContrainerManageMember">
        <div class="row">
            <div class="col1">
                <p class="text-3xl">จัดการข้อมูลสมาชิก</p>
            </div>
        </div>
        <div class="row">
            <div class="col2">
                    ...
                    <table class="table text-lg">
                        ...
                        <thead>
                            <tr class="text-lg tableHeaders">
                                ...
                                <th class="tableHeadersEmail">อีเมล</th>
                                <th class="tableHeadersDate">วันเกิด</th>
                                <th class="tableHeadersStatus">สถานนะ</th>
                            </tr>
                        </thead>
                        <tbody>
                            <!-- row 1 -->
        ...
        <div class="row">
            <div class="col5">
                ...
                <p class="text-lg" id="userCount">จำนวนบัญชีผู้ใช้ทั้งหมด : <span id="countValue">10</span></p>
            </div>
            <div class="col6">
