    ...
    <div class="navbar bg-base-200">
        <details class="dropdown " id="manage">
            ...
            <ul class="ManageDrop p-2 shadow menu dropdown-content z-[1] bg-base-200 rounded-box w-max text-lg">
                <li><a href="manage_member.php" class=" mt-2 mb-2 group hover:text-xl"><i class="fa-solid fa-circle"
                            style="color: #a3a3a3;"></i>จัดการข้อมูลสมาชิก</a></li>
                <li><a href="recommend_game.php" class=" mt-2 mb-2 group hover:text-xl"><i
                            class="fa-solid fa-circle fa-beat" style="color: #ffffff;"></i>จัการแนะนำเกม</a></li>
                <li><a href="category_game.php" class=" mt-2 mb-2 group hover:text-xl"><i class="fa-solid fa-circle"
                            style="color: #a3a3a3;"></i>จัดการหมวดหมู่เกม</a></li>
                <li><a href="categort_rating.php" class=" mt-2 mb-2 group hover:text-xl"><i class="fa-solid fa-circle"
                            style="color: #a3a3a3;"></i>จัดการหมวดหมู่เรตติ้งเกม</a>
                </li>
                <li><a href="manage_game.php" class=" mt-2 mb-2 group hover:text-xl"><i class="fa-solid fa-circle"
                            style="color: #a3a3a3;"></i>จัดการทะเบียนเกม</a></li>
                <li><a href="manage_comment.php" class=" mt-2 mb-2 group hover:text-xl"><i class="fa-solid fa-circle"
                            style="color: #a3a3a3;"></i>จัดการความคิดเห็น</a></li>
                <li><a href="manage_scoregame.php" class=" mt-2 mb-2 group hover:text-xl"><i class="fa-solid fa-circle"
                            style="color: #a3a3a3;"></i>ตรวจสอบคะแนนเกม</a></li>
                <li><a href="manage_review_issue.php" class=" mt-2 mb-2 group hover:text-xl"><i
                            class="fa-solid fa-circle" style="color: #a3a3a3;"></i>จัดการประเด็นรีวิว</a>
                </li>
                <li><a href="manage_post.php" class=" mt-2 mb-2 group hover:text-xl"><i class="fa-solid fa-circle"
                            style="color: #a3a3a3;"></i>จัดการโพสต์รีวิว</a></li>
                <li><a href="manage_review.php" class=" mt-2 mb-2 group hover:text-xl"><i class="fa-solid fa-circle"
                            style="color: #a3a3a3;"></i>จัดการรีวิว</a></li>
            </ul>
        </details>
        <div class="flex-1">
        ...
        <div class="row">
            <div class="row1">
                <div class="col col111">
                    ...
                    <textarea placeholder="เกมที่เลือกปัจจุบัน"
                        class="selectedGame textarea textarea-bordered textarea-sm text-lg w-full max-w-full"
                        readonly>Dying Light 2 Stay Human</textarea>
                    ...
                    <div class="SearchGame">
                        <input type="text" placeholder="ค้นหาเกม"
                            class="SearcGame input input-bordered text-lg w-full max-w-full" />
        ...
        <div class="row">
            <div class="row3">
                <div class="col col77">
                    ...
                    <div class="SearchGame">
                        <input type="text" placeholder="ค้นหาเกม"
                            class="input input-bordered text-lg w-full max-w-full" />
                        <button class="btn text-lg">ตกลง</button>
                    </div>
                    <p class="text-xl font-bold mt-4 mb-4">ภาพเกม</p>
                    <div class="image-box-Re">
        ...
        <div class="row">
            <div class="row1">
                <div class="col col1">
                    ...
                    <div class="SearchGame">
                        <input type="text" placeholder="ค้นหาเกม"
                            class="input input-bordered input-info text-lg w-full max-w-full" />
                        <button class="btn text-lg">ตกลง</button>
                    </div>
                    <p class="text-xl font-bold mt-4 mb-4">ภาพเกม</p>
                    <div class="image-box-Re">
